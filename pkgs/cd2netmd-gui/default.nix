...
stdenv.mkDerivation (finalAttrs: {
  ...
  postPatch = ''
    ...
    # Replace deprecated Q_OS_MAC macro with Q_OS_DARWIN
    substituteInPlace caboutdialog.cpp cdaoconfdlg.cpp cffmpeg.cpp cjacktheripper.cpp \
    cjacktheripper.h cxenc.cpp cxenc.h main.cpp mainwindow.cpp \
      --replace-fail \
        'Q_OS_MAC' \
        'Q_OS_DARWIN'
